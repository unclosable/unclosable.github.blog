...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Timer, null), document.getElementById('forkme_banner'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClickTitleChild = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            this.props.theHrefText
	        );
	    }
	});
	var ClickTitle = React.createClass({
	    displayName: 'ClickTitle',
	
	    render: function render() {
	        return React.createElement(
	            'a',
	            { id: 'unclosablegithubio', className: 'anchor', href: this.props.thehref, 'aria-hidden': 'true' },
	            React.createElement(ClickTitleChild, { theHrefText: this.props.theHrefText })
	        );
	    }
	});
	var Title = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'h1',
	            null,
	            React.createElement(ClickTitle, { theHrefText: this.props.theHrefText, thehref: this.props.thehref }),
	            ' ',
	...
	var Section = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'section',
	            { id: 'main_content', className: 'inner' },
	            React.createElement(Title, { theHrefText: this.props.theHrefText, thehref: this.props.thehref, titlsText: this.props.titlsText }),
	            React.createElement(Content, { contentText: this.props.contentText })
	        );
	    }
	});
	$.get("data/content.json", function (result) {
	    ReactDOM.render(React.createElement(
	        ...
	        result.map(function (r, s) {
	            return React.createElement(Section, { key: s, theHrefText: r.theHrefText, thehref: r.thehref, titlsText: r.titlsText, contentText: r.contentText });
	        })
	    ), $("#main_content_wrap")[0]);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoApp = React.createClass({
	    ...
	    addNewMessage: function addNewMessage(data) {
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'td',
	                                null,
	                                React.createElement('input', { onChange: this.onEditorChange, value: this.state.editor, className: 'titleInput' })
	                            )
	                        ),
	                        React.createElement(
	                            'tr',
	                            ...
	                            React.createElement(
	                                'td',
	                                null,
	                                React.createElement('textarea', { onChange: this.onContentChange, value: this.state.content, className: 'contentInput' })
	                            )
	                        ),
	                        React.createElement(
	                            'tr',
	...
	$.get("data/message.json", function (result) {
	    ...
	    var todoApp = ReactDOM.render(React.createElement(TodoApp, { items: result, messageSender: messageSender }), $("#mountNode")[0]);
	    //注册收到信息的事件
